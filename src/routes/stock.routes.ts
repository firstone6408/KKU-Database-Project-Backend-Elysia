...
export const stockRouters = baseRouter.group("/stock", { tags: ["Stocks"] }, (app) => app
    ...
    .guard({ isVerifyAuth: true }, (app) => app
        ...
        .put("/update/:id/product/:productId", ({ params: { id, productId }, body, store: { user } }) => withRequestHandling(async () => 
        {
        ...
        .put("/transfer/:id/product/:productId/branch/:branchId", () => withRequestHandling(async () =>
        {
            return { payload: { data: {} } }
        }),
            {
        ...
        .put("/adjust/:id/product/:productId/branch/:branchId", () => withRequestHandling(async () =>
        {
            return { payload: { data: {} } }
        }),
        ...
        .get("/:id/history", ({ params: { id } }) => withRequestHandling(async () =>
        {
